export const ALLY_TYPES = {
    ...
    raccoon: { cost: 1200, hp: 250, speed: 1.5, damage: 55, range: 20, cooldown: 500, color: 0x8d6e63, w: 35, h: 35, name: '너구리', bonusKnockback: 0.1, scale: 0.6, unlockStage: 4, canRespawn: true }
};
...
export const ENEMY_TYPES = [
    ...
    { type: 'gekko', hp: 200, speed: -1.5, damage: 18, range: 30, cooldown: 1000, color: 0x2ecc71, w: 60, h: 60, bonusKnockback: 0.2, scale: 0.407, reward: 100, isInverted: true, unlockStage: 8 }
];
